...
/// <summary>
/// Clase utilizada para Singletons que sean MonoBehaviour. Si al llamar a la Instancia, su valor es nulo, buscará formas de autoinicializarse de las siguentes formas:
/// <list type="number">
/// <item><description>Buscar un objeto existente en escena.</description></item>
/// <item><description>Instanciar un objeto vacío con el componente <typeparamref name="T"/>.</description></item>
/// <item><description>Si <see cref="PrefabPath"/> no es vacío, intentar cargar desde Resources.</description></item>
/// </list>
...
public class SingletonMonoBehaviour<T> : MonoBehaviour where T : Component
{
    ...
    /// Si no se encuentra o la ruta está vacía, se instanciará un objeto vacío con el componente.
    /// <para>
    /// Ejemplo de uso: para un prefab ubicado en <c>Assets/Resources/Prefabs/MusicManager.prefab</c>,
    /// este valor debería ser <c>"Prefabs/MusicManager"</c>.
    /// </para>
    /// </summary>
    ...
    /// Si es <c>true</c>, se aplicará <see cref="Object.DontDestroyOnLoad(UnityEngine.Object)"/> automáticamente.
